...
2.	Welke sporen in de PCAP duiden op ongeautoriseerde toegang tot of manipulatie van de PLC via het netwerk?
3.	Welke aanwijzingen in de PLC-memorydump wijzen op een wijziging van het PLC-programma?
4.	In welke toestand bevindt de PLC zich op het moment van de dump, en wat zegt dit over het liftgedrag?
5.	Welk verband is er aantoonbaar tussen de activiteit op de desktop van Kristi en het lift-incident?
6.	Welke rol heeft de software op Kristi's computer gespeeld bij het lift-incident?
7.	In hoeverre zijn de bevindingen uit het rapport reproduceerbaar a.d.h.v. onafhankelijk analyse met dezelfde bewijsstukken?